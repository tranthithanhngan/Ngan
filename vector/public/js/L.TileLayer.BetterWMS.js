L.TileLayer.BetterWMS = L.TileLayer.WMS.extend({
    ...
    showGetFeatureInfo: function (err, latlng, content) {
      ...
      console.log(content.features[0].properties.tua_de)
      // Otherwise show the content in a popup, or something.
      L.popup({ maxWidth: 800})
        .setLatLng(latlng)
        .setContent(`<h2>Tuyến ĐTNĐ<h2>
        <p> <h3 >Tựa đề:</h3> <span> ${content.features[0].properties.tua_de}</span></p>
        <p> <h3>Vị trí thượng lưu:</h3><span>  ${content.features[0].properties.vitrithuongluu}</span></p>
        <p> <h3>Loại quản lý:</h3><span>  ${content.features[0].properties.loaiquanli}</span></p>`)
        .openOn(this._map);
    }
